...
A mechanism to automate the deployment of infrastructure via scripting to the varous IaaS platforms.

Some of the platforms are
image::IaCPlatforms.png[Infrastructure As Code Platforms]

===== Terraform
Terraform is a platform that abstracts the complexities of each of the cloud environments from the administrators/end users.
