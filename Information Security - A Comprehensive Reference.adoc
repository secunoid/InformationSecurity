...
followed by at least an annual Penetration Testing exercise, where an human being attempts to break the application using various mechanisms that only a human being can manage.
