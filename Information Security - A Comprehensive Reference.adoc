...
*main.tf* is a Terraform configuration file that contains blocks of code to to provision the infrastructure. Can be available via version control systems for easy maintainability.
...
* Apply: Makes the necessary changes on the environment to bring it to the target state.
