...
I have created a seperate document listing some of the https://github.com/secunoid/InformationSecurity/blob/master/PenetrationTestingTools.adoc[Penetration Testing Tools] that I have used.
