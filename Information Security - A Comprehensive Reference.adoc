...
image::PMOStructure-Centralized.png[Centralized PMO]

===== De-Centralized

image::PMOStructure-DeCentralized.png[De-centralized PMO with COE]
...
===== Gates
"Gates" are checkpoints where two distinct teams should be reviewing the projects.  First review should be done by the 
Each of the "Gates" that I have specifed are checkpoints were a team of 

===== Steering Committee Meetings
Also called Steerco meetings as held with project sponsors where identified project risks are discussed and 
...
. Business alignment for required org structure
