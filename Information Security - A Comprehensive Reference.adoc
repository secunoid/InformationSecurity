...
Use this template https://github.com/secunoid/InformationSecurity/blob/master/Templates/SecurityThreatAssessment-IncidentResponseReport-Template-v01.odt[Security Threat Assessment & Incident Response Report] as required.
