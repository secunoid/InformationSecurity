...
Enterprise architecture is about overseeing these changes by defining various architecture principles and standards.  Architects then govern those changes to ensure that the standards and principles are being followed.f
...
=== SABSA
SABSA is a framework that supports the business in reachign its goals
