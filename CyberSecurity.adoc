...
*Architecture* is a designed structure of something.  A descript on of the structure (components) and behavious (Processes) of a system.  It is also an activity required to produce such a description.
...
. Conceptual Architecture: The Architect's vision (The 'big picture', business attribures profiel and risk objectives)
...
The SABSA framework is flexible, scable and applicable to any industry sector.  Instead of replacing other risk based standards, it can be combined with TOGAF, COBIT and ITIL to create an integrated compliance framework.
...
* Not necessariity coveredy by insurance
