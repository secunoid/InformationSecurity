...
. Disable IP v6
	...
	*Get Status of IP v6* Get-NetAdapterBinding -ComponentID ‘ms_tcpip6’
	*Disable IPv6* Get-NetAdapterBinding -ComponentID ‘ms_tcpip6’ | Disable-NetAdapterBinding -ComponentID ‘ms_tcpip6’ -PassThru
